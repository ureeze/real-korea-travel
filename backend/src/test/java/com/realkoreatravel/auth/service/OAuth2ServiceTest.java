...
class OAuth2ServiceTest {
    ...
    void findOrCreateMember_existingMember_returnsExisting() {
        Member existing = new Member("user@gmail.com", "홍길동", "https://example.com/picture.png", "GOOGLE", "google-sub-123");
    ...
    void findOrCreateMember_newMember_createsAndSaves() {
        ...
        Member saved = new Member("user@gmail.com", "홍길동", "https://example.com/picture.png", "GOOGLE", "google-sub-123");
