...
- 인증: `POST /api/v1/auth/google`, `POST /api/v1/auth/refresh`
- 헬스: `GET /health`
- 장소: `GET /api/v1/places`, `GET /api/v1/places/{placeId}`, `GET /api/v1/search`
- 즐겨찾기: `POST/DELETE/GET /api/v1/bookmarks`
